...
<?php include("connexionbd.php");
         ...
         <h1>Reserver un stand pour <span><?php echo $data['nom'] ?></span><sup>Vous serez remboursé seulement en cas d'annulation de l'évènement</sup></h1>
<!--
...
<form action="reservation.php" method="POST">
 ...
 <input type="hidden" name="type_reservation" value="stand">
 <script
   ...
   data-button-text="Reserver mon stand"
